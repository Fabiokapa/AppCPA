               ...
               if($result->num_rows > 0){
                    while($dado = $result->fetch_assoc()){
                        ...
                        <tr>
                            ...
                            <td><?=$dado['id_curso']?></td>
                            <td id="opc-pesquisa">
                                <a href="../template/CA-propina.php?id_aluno=<?=$dado['id_aluno']?>"> <i class="fas fa-user-edit"></i> </a>
                                <a href="../template/'C-list-pagamento.php?id_aluno=<?=$dado['id_aluno']?>"> <i class="fas fa-list-ul"></i> </a>
                            </td>
                        </tr>
                    <?php }
               } else {
